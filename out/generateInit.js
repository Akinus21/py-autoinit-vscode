...
exports.generateInitForFolder = generateInitForFolder;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
// Recursively collect all folders excluding __pycache__
function collectFolders(dir, recursive, folders = []) {
    if (path.basename(dir) === '__pycache__')
        return folders;
    folders.push(dir);
    if (!recursive)
        return folders;
...
async function generateInitForFolder(folder, recursive = true, verbose = true) {
